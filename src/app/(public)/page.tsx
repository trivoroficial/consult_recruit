          ...
          <motion.div className="relative z-10 mx-auto flex w-full max-w-7xl px-4 sm:px-6 lg:px-8" style={{ y: overlayY }}>
            <div className="max-w-4xl space-y-8 py-12 lg:py-20">
              ...
              <motion.div className="flex flex-col gap-3 sm:flex-row" initial={{ opacity: 0, y: 24 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.4, duration: 0.85 }}>
                ...
                <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="px-6 py-3 text-sm font-semibold text-white bg-white/20 backdrop-blur-sm border border-white/40 rounded-full hover:bg-white/30 hover:-translate-y-0.5 transition-all">
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {testimonials.map((item, index) => (
                <motion.div key={index} className="bg-[#F8F7F4] border border-[#E8EAE0] rounded-2xl p-8 hover:shadow-lg transition-all duration-300" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={fadeUp}>
            ...
            <div className="grid gap-8 lg:grid-cols-2">
              <div className="bg-white border border-[#E8EAE0] rounded-2xl p-8">
                ...
                <div className="mt-6 space-y-4">
                  <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="flex items-center gap-4 p-4 border border-[#E8EAE0] rounded-xl hover:border-[#8E7AB5] hover:bg-[#F8F7F4] transition-all">
                  ...
                  <a href={`mailto:${emailContato}`} className="flex items-center gap-4 p-4 border border-[#E8EAE0] rounded-xl hover:border-[#8E7AB5] hover:bg-[#F8F7F4] transition-all">
              ...
              <div className="bg-white border border-[#E8EAE0] rounded-2xl p-8">
                ...
                <form className="mt-6 grid gap-4" onSubmit={submitContact}>
                  <div>
                    ...
                    <input className="w-full px-4 py-3 border border-[#E8EAE0] rounded-xl focus:border-[#8E7AB5] focus:ring-2 focus:ring-[#8E7AB5]/20 outline-none transition" type="text" name="nome" placeholder="Seu nome" value={formState.nome} onChange={(e) => setFormState({...formState, nome: e.target.value})} required />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-[#2D3121]">Telefone</label>
                    <input className="w-full px-4 py-3 border border-[#E8EAE0] rounded-xl focus:border-[#8E7AB5] focus:ring-2 focus:ring-[#8E7AB5]/20 outline-none transition" type="tel" name="telefone" placeholder="(00) 00000-0000" value={formState.telefone} onChange={(e) => setFormState({...formState, telefone: e.target.value})} required />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-[#2D3121]">Empresa</label>
                    <input className="w-full px-4 py-3 border border-[#E8EAE0] rounded-xl focus:border-[#8E7AB5] focus:ring-2 focus:ring-[#8E7AB5]/20 outline-none transition" type="text" name="empresa" placeholder="Nome da sua empresa" value={formState.empresa} onChange={(e) => setFormState({...formState, empresa: e.target.value})} />
                  </div>
                  <div>
                    <label className="block text-sm font-medium text-[#2D3121]">Email</label>
                    <input className="w-full px-4 py-3 border border-[#E8EAE0] rounded-xl focus:border-[#8E7AB5] focus:ring-2 focus:ring-[#8E7AB5]/20 outline-none transition" type="email" name="email" placeholder="voce@empresa.com.br" value={formState.email} onChange={(e) => setFormState({...formState, email: e.target.value})} required />
                  </div>
                  <div>
