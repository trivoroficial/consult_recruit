      ...
      <header className={cn(
        ...
        <div className="mx-auto flex max-w-7xl items-center justify-between px-4 py-3 sm:px-6 lg:px-8">
          ...
          <div className="hidden items-center gap-3 lg:flex">
            <Link href="/login">
              <button className="px-4 py-2 text-sm font-medium text-[#708090] hover:text-[#8B0000] transition">Entrar</button>
            </Link>
            <Link href="/cadastro">
          ...
          <button className="inline-flex flex-col items-center justify-center gap-1 rounded-xl border border-[#8B0000]/20 bg-white px-4 py-3 lg:hidden" type="button" onClick={() => setMenuOpen((open) => !open)}>
            ...
            <div className="mx-auto flex max-w-7xl flex-col gap-3">
              ...
              <div className="flex flex-col gap-3 pt-4 border-t border-[#8B0000]/10">
                <Link href="/login" onClick={() => setMenuOpen(false)}>
                  <button className="w-full py-3 text-sm font-medium text-[#708090] border border-[#708090] rounded-lg hover:bg-[#F1F2F3] transition">Entrar</button>
                </Link>
                <Link href="/cadastro" onClick={() => setMenuOpen(false)}>
                  <button className="w-full py-3 text-sm font-semibold text-white bg-[#8B0000] rounded-lg hover:bg-[#E3C9A8] hover:text-[#8B0000] transition">Solicitar Diagnóstico</button>
                </Link>
              </div>
            </div>
          </div>
          ...
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8">
            ...
            <div className="grid gap-6 md:grid-cols-2">
              {solucoes.map((item, index) => (
                <motion.div key={index} className="bg-white border border-[#F8F4E6] rounded-xl p-6 flex items-start gap-4 hover:shadow-lg hover:-translate-y-1 hover:border-[#8B0000]/30 transition-all duration-300" initial="hidden" whileInView="visible" viewport={{ once: true, amount: 0.3 }} variants={fadeUp}>
        ...
        <section className="py-16 md:py-20 bg-[#2D343A]">
          <div className="mx-auto max-w-7xl px-4 sm:px-6 lg:px-8 text-center">
            ...
            <div className="mt-8 flex flex-col justify-center gap-3 sm:flex-row">
              ...
              <a href={whatsappUrl} target="_blank" rel="noopener noreferrer" className="px-8 py-4 text-sm font-bold text-white border-2 border-white/40 rounded-lg hover:bg-white hover:text-[#8B0000] hover:border-white transition-all duration-300 flex items-center justify-center gap-2">
