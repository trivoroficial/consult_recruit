              ...
              <div className="text-sm text-[#2D343A]">
                ...
                {mostrarLGPD && (
                  <div className="mt-2 p-3 bg-white rounded-lg border border-[#E8EAE0] text-xs text-[#708090] max-h-40 overflow-y-auto">
                    ...
                    <p className="mt-1">Você tem direito a acessar, corrigir ou excluir seus dados a qualquer momento. Ao aceitar, você concorda com o tratamento dos seus dados conforme descrito.</p>
                    <button
                      type="button"
