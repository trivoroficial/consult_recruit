...
export default function Login() {
  ...
  // ============================================
  // O usuário NUNCA será redirecionado automaticamente
  // Ele SEMPRE precisa digitar email e senha
      ...
      <div className="bg-white rounded-2xl shadow-xl p-8 border border-[#E8EAE0]">
        ...
        <form onSubmit={handleLogin} className="space-y-4">
          ...
          <button
            ...
            className="w-full py-3.5 bg-[#6B1A2A] hover:bg-[#4A0E1A] text-white font-semibold rounded-lg transition-all duration-300 shadow-md shadow-[#6B1A2A]/20 hover:shadow-lg hover:-translate-y-0.5 flex items-center justify-center gap-2 disabled:opacity-50 disabled:cursor-not-allowed disabled:hover:translate-y-0"
          >
            {loading ? (
