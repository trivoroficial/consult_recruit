              ...
              <table className="w-full">
                ...
                <tbody>
                  <tr className="border-b border-[#E8EAE0]">
                    <td className="py-3 px-4 font-medium text-[#2D343A]">Empresa XPTO</td>
                    <td className="py-3 px-4 text-[#708090]">12.345.678/0001-99</td>
                    <td className="py-3 px-4 text-[#708090]">Uberlândia/MG</td>
                    <td className="py-3 px-4"><span className="px-2 py-1 bg-green-100 text-green-700 rounded-full text-xs">Ativo</span></td>
