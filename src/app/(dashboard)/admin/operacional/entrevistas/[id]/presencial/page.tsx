...
import { 
  ...
  Calendar, MessageSquare, AlertCircle, Users,
  ChevronLeft, ChevronRight, FileText, Edit
} from 'lucide-react'

export default function RealizarEntrevistaPresencial() {
      ...
      <div className="min-h-screen bg-[#F8F4E6] flex flex-col">
        ...
        <div className="flex-1 ml-64 flex items-center justify-center">
          <div className="bg-white rounded-2xl shadow-xl p-12 text-center max-w-md">
            ...
            <p className="text-[#708090] mt-2">As respostas foram registradas com sucesso.</p>
          </div>
        </div>
      </div>
    )
        ...
        <div className="flex-1 p-8">
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4 mb-6">
            ...
            <div className="bg-white p-4 rounded-xl shadow-sm border border-[#E8EAE0] flex items-center gap-3">
              ...
              <div>
                <p className="text-xs text-[#708090]">Modalidade</p>
                <p className="font-medium text-[#2D343A]">Presencial</p>
              </div>
            </div>
          </div>
          ...
          <div className="bg-white rounded-xl shadow-sm border border-[#E8EAE0] p-8">
            ...
            <div className="space-y-4">
              <div>
                <label className="block text-sm font-medium text-[#2D343A] mb-2">Resposta do participante</label>
                <textarea
                  rows={4}
                  ...
                  placeholder="Registre a resposta do participante..."
