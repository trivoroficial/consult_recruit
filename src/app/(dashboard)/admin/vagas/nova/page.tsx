...
import { Briefcase, MapPin, DollarSign, Users, Save, ArrowLeft, CheckCircle, Calendar, Clock } from 'lucide-react'
              ...
              <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    placeholder="Vale transporte, Vale alimentação, Plano de saúde, Gympass..."
                  />
                </div>
                ...
                <div className="md:col-span-2">
                  ...
                  <textarea
                    ...
                    placeholder="Excel, Liderança, Comunicação, Gestão de Projetos..."
                  />
                </div>
