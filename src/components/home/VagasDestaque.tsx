      ...
      <div className="container mx-auto px-4">
        ...
        {vagas.length === 0 ? (
          <div className="text-center py-12 bg-white rounded-2xl border border-[#E5E7EB]">
            ...
            <h3 className="text-xl font-bold text-[#1A1A2E]">Em breve novas vagas</h3>
            <p className="text-[#6B7280] mt-2">Cadastre-se para receber notificações de oportunidades</p>
            <Link href="/cadastro">
              <button className="mt-4 px-6 py-2 bg-[#8B1A2A] text-white rounded-lg hover:bg-[#6B0A1A] transition">
                Cadastrar
              </button>
            </Link>
          </div>
