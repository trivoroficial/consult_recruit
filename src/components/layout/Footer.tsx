        ...
        <div className="grid grid-cols-1 gap-8 md:grid-cols-4">
          ...
          <div>
            ...
            <ul className="space-y-3 text-sm text-gray-400">
              ...
              <li className="hover:text-purple-400 transition-colors cursor-pointer">Projetos Especiais</li>
            </ul>
          </div>
        ...
        <div className="mt-12 pt-8 border-t border-gray-800">
          <div className="flex flex-col md:flex-row justify-between items-center gap-4">
            <p className="text-sm text-gray-500">
              &copy; 2026 TRIVOR. Todos os direitos reservados.
            </p>
            <div className="flex gap-6 text-sm">
              <Link href="/privacidade" className="text-gray-500 hover:text-purple-400 transition-colors">
                Política de Privacidade
              </Link>
              <Link href="/termos" className="text-gray-500 hover:text-purple-400 transition-colors">
                Termos de Uso
              </Link>
              <Link href="/lgpd" className="text-gray-500 hover:text-purple-400 transition-colors">
                LGPD
              </Link>
            </div>
          </div>
